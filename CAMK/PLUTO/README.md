...
3. Once complete, we can now modify settings via the interactive `plutosetup` script and generate our makefile by choosing:
   - `Linux.gcc.defs` for single core compilation
   - `Linux.mpicc.defs` for multi core compilation
5. To compile the code, in the working directory run: `make`
