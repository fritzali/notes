...
Authors: Isidora Jankov & Dr. Andjelka KovaДЌeviД‡
...
written by Dr. Andjelka KovaДЌeviД‡. There were several improvements introduced
in this module:
...
- KovaДЌeviД‡ et al. (2021, MNRAS, 505, 5012-5028)
...
from add_asym import add_asym
      ...
      # (adapted from original python code by Dr. Andjelka KovaДЌeviД‡,  #
...
def lc_conti(T, osc=True, A=0.14, noise=0.00005, z=0, method='Kelly1', 
    ...
    For further details regarding the model see KovaДЌeviД‡ et al. (2021) and 
    references therein.
    ...
    err: np.array
        Light curve error (IveziД‡ et al. 2019)
    rblr: float
        BLR radius of the simulated light curve in days (i.e., time-lag).
        
    References:
    -----------
    * IveziД‡, ЕЅ., et al. 2019, ApJ, 873, 111 
