...
\begin{equation*}
	n = n_0 \!\left(1 \kern-0.5pt + r^2 \kern-1pt/ r_c^2 \right)^{-3\kern-1pt\beta\kern-0.5pt/\kern+0.5pt 2}
\end{equation*}
...
\begin{equation*}
	\vphantom{\int}T = T_0 \,\frac{x_\text{cool} + T_\text{min} / T_0 \vphantom{^{\int}}}{x_\text{cool} + 1}
...
First, with an averaged overdensity concentration, we use
\begin{equation*}
	P = P_0 
\end{equation*}
\cite{arna2010}
